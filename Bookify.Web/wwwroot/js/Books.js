    ...
    datatable = $('#Books').DataTable({
        ...
        columns: [
            { "data": "id", "name": "Id", "className": "d-none" },
            {
                ...
                "render": function (data, type, row) {
                    return `<div class="symbol symbol-50px overflow-hidden me-3">
												...
												<a href="/Books/Details/${row.id}" class="text-gray-800 text-hover-primary fw-bolder mb-1">${row.title}</a>
												<span>${row.author}</span>
											</div>`;
                }
            },
            { "data": "publisher", "name": "Publisher" },
            { "name": "PublishingDate", "render": function (data, type, row) { return moment(row.publishingDate).format('ll') } },
            { "data": "hall", "name": "Hall" },
            ...
            },
            {
                ...
                "orderable": false,
                "render": function (data, type, row) {
                    return `<button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
			<!--begin::Svg Icon-->
